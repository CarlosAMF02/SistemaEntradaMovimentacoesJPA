...
public class MovimentacaoEntrada implements Serializable{
	...
	private static final long serialVersionUID = -5139521239644753486L;
	
	public MovimentacaoEntrada() {
		
	}

	public MovimentacaoEntrada(String tipoMovimentacao, LocalDateTime dataMovimentacao, Entrada entrada,
	...
	public String toString() {
		...
		+ "\nData Movimentacao: " + this.getDataMovimentacao().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"))
